...
The long-form design documents at the repository root
(`CONCEPT.md`, `ARCHITECTURE.md`, `NPC-INTELLIGENCE.md`,
`BUILD-PLAN.md`) remain the canonical source of truth
for story, deep architecture rationale, and the original
phased plan. The six files above are the working summaries
