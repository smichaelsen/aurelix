...
_MODEL_SUGGEST  = "claude-haiku-4-5"
...
class AnthropicHaikuProvider:
    ...
    def classify_topic(self, req: ClassifyTopicRequest) -> ClassifyTopicResponse:
        ...
        text = self._call(_MODEL_CLASSIFY, system, user, max_tokens=120)
    ...
    def suggest_player_options(
        ...
        text = self._call(_MODEL_SUGGEST, SUGGEST_SYSTEM_PROMPT, user_content, max_tokens=300)
